...
public class Takeoff extends Scene{
	...
	public Takeoff(Visuals v) {
		...
		starship = new Animatable(v, "assets/full_starship.png", d.vw(47f), d.vh(47f), Map.of("prop", (float) d.vw(26f), "parallax", 0.001f));
		...
		//Sprite animations
		starship.animateProperty(Map.of("property", Properties.YPOS.getValue(), "to", -300, "startTime", 300, "duration", 600), -d.vh(0.0003f));
		starship.animateProperty(Map.of("property", Properties.YPOS.getValue(), "to", (int) -d.vh(10f), "startTime", 900, "duration", 300), 0);
		flame.animateProperty(Map.of("property", Properties.YPOS.getValue(), "to", -300, "startTime", 300, "duration", 600), -d.vh(0.0003f));
