...
public class BoosterLanding extends Scene{
	...
	public BoosterLanding(Visuals v) {
		...
		starship = new Animatable(v, "assets/superheavy_booster.png", d.vw(47f), -d.vh(10f), Map.of("prop", (float) d.vw(15f), "parallax", 0.001f));
		flame = new Animatable(v, "assets/flames.png", d.vw(47f), d.vh(62f), Map.of("prop", (float) d.vw(3f), "parallax", 0.001f));
